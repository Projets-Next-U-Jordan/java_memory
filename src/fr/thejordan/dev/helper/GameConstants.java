...
public class GameConstants {
	...
	public static final String GAME_OVER_TIME_UP_MESSAGE = "Temps écoulé ! Recommencer ?";
	public static final String GAME_OVER_NO_MORE_TRIES_MESSAGE = "Plus d'essais ! Recommencer ?";
